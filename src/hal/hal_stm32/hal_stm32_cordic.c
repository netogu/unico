...
void cordic_write(uint32_t args) { CORDIC->WDATA = args; }

uint32_t cordic_read(void) { return CORDIC->RDATA; }
...
int cordic_result_is_ready(void) { return CORDIC->CSR & CORDIC_CSR_RRDY; }
